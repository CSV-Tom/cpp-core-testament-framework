...
if(NOT test_root_is_in_binary_dir
   ...
   OR NOT test_root_name STREQUAL "core-services-install-consumer-test")
...
if(NOT install_result EQUAL 0)
    message(FATAL_ERROR "CoreServices installation failed:\n${install_output}${install_error}")
endif()
...
if(NOT configure_result EQUAL 0)
    message(FATAL_ERROR "CoreServices consumer configuration failed:\n${configure_output}${configure_error}")
endif()
...
if(NOT build_result EQUAL 0)
    message(FATAL_ERROR "CoreServices consumer build failed:\n${build_output}${build_error}")
endif()
...
if(NOT test_result EQUAL 0)
    message(FATAL_ERROR "CoreServices consumer execution failed")
endif()
